                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        ...
                        {form.formState.errors.image && (
                            <p className="text-red-500 text-center text-xs">{form.formState.errors.image?.message?.toString()}</p>
                        )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="John Doe" {...field} className="w-full p-3 py-4 rounded-lg  text-white outline-none " />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="johndoe" {...field} className="w-full p-3 py-4 rounded-lg  text-white outline-none " />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
